    ...
    <div className="experience-body" id="Experience">
      ...
      <div className="experience-cards">
        <div className="card">
          ...
          <p>
            I started my journey as a tech student in 2022 at UCOL, where I had
            to adapt to a new environment. With minimal knowledge in tech, I
            knew I had to change, so I started grinding C# at home to impress my
            peers.
        ...
        <div className="card">
          ...
          <h2>UCOL Palmerston North</h2>
          <p>
            Building on my previous studies, I am currently pursuing my
            Bachelor's degree in ICT at UCOL. This phase of my education has
            pushed me to explore advanced concepts in software development,
            networking, and system architecture. Beyond the classroom, I
            continue refining my skills by working on real-world projects and
